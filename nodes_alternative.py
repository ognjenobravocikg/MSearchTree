    ...
    def get_left_subtree(self, key):
        for i, item in enumerate(self.keys):
            if key == item:
                ...
                if self.children:
                    return self.children[i].get_left_subtree(key)
                return None
        if self.children:
            return self.children[-1].get_left_subtree(key)
        return None
    ...
    def get_right_subtree(self, key):
        for i, item in enumerate(self.keys):
            if key == item:
                ...
                if self.children:
                    return self.children[i].get_right_subtree(key)
                return None
        if self.children:
            return self.children[-1].get_right_subtree(key)
        return None
